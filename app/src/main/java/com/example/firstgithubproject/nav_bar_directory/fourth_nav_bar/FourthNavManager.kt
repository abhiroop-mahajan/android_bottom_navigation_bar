...
import com.example.firstgithubproject.databinding.ItemFourthNavBarBinding
import com.example.firstgithubproject.databinding.ItemThirdNavBarBinding
import com.example.firstgithubproject.fragments.*

class FourthNavManager (listener:SaveData, context: Context, fragmentManager: FragmentManager, navBarBinding: ItemFourthNavBarBinding){
    ...
    private var binding: ItemFourthNavBarBinding
    ...
    private fun updateIndicator(tab: Int) {
        ...
        binding.vIndicator.updateLayoutParams<ConstraintLayout.LayoutParams> {
            ...
            topToBottom = tabListener[tab].id
